...
module CandlepinAPI
  ...
  # REST endpoint definition
  #
  class Endpoint_Consumers_by_Consumer_Uuid_Checkin < Endpoint

    URI_Regex_String	= '^consumers/([^/]+)/checkin/?$'
    URI_Regex		= Regexp.new(URI_Regex_String)
    PathParams		= [
			   'consumer_uuid',
			  ]
  ...
  end  # REST endpoint class Endpoint_Consumers_by_Consumer_Uuid_Checkin

  #
  # Classes for access by HTTP method/verb
  # to endpoint Endpoint_Consumers_by_Consumer_Uuid_Checkin
  #
  class UpdateLastCheckinConsumer < Endpoint_Consumers_by_Consumer_Uuid_Checkin
    #
    # PUT /candlepin/consumers/{consumer_uuid}/checkin
    #

    include EntrypointExtensions

    API_Method_Full_Name = 'org.candlepin.resource.ConsumerResource.updateLastCheckin'
    ...
    def rqtype
      return :updateLastCheckinConsumer
    end

  end  # REST entrypoint class UpdateLastCheckinConsumer
  ...
  # REST endpoint definition
  #
  class Endpoint_Products_by_Prod_Id_Statistics < Endpoint
  ...
  end  # REST endpoint class Endpoint_Products_by_Prod_Id_Statistics

  #
  # Classes for access by HTTP method/verb
  # to endpoint Endpoint_Products_by_Prod_Id_Statistics
  #
  class GetProductStats < Endpoint_Products_by_Prod_Id_Statistics
    #
    # GET /candlepin/products/{prod_id}/statistics
    #
