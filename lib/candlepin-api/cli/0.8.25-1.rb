#
# Command-line definitions for API defined in /home/coar/othergit/candlepin-api/data/candlepin_methods-candlepin-0.8.25-1.json.
#
require('rubygems')
require('cri')
require('optparse')
...
No description available for this entrypoint.
    ...
    content will be read from stdin.
    EOD
    cdef.required(nil, :capability,
                  "[Query argument] A string.") do |value,cmd|
      CandlepinCLI.options.capability = value
    end
    cdef.required(nil, :name_search,
                  "[Query argument] A string.") do |value,cmd|
      CandlepinCLI.options.name_search = value
    end
    cdef.run do |opts,args,cmd2|
